        ...
        <header class="top-bar">
            <nav class="navbar navbar-default">
                <ul class="nav navbar-nav">
                    ...
                    <li class="page-title">
                        <h2>Add Video On Home Category</h2>
                    </li>
                </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default panelMove panelFullscreen panelToggle panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal group-border stripped" enctype="multipart/form-data" method="post" action="add.php">
                                        
                                        <!-- End .form-group  -->
										<div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for="">Select Home category</label>
										...
										<input type="Submit" name="Submit" value="Submit" style="background-color:red">
										 <label class="col-lg-7 col-md-5  control-label" for="">Add Multiple Video in Category</label>
                                            </center>
                                        </div>  
										...
										<?php 
											...
											for($i =1 ; $i<=20 ;$i++) { 	
												...
												?>
												  <tr>
													<td><?php echo $i;?></td>
													<td><input type="text" id="subject_<?php echo $i;?>" class="form-control" name="pname[]" placeholder="Topic Name"></td>
