...
$result = mysqli_query($mysqli, "SELECT * FROM category ORDER BY id DESC"); // using mysqli_query instead
?>
<!doctype html>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default panelMove panelFullscreen panelToggle panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal group-border stripped" enctype="multipart/form-data" method="post" action="add_cat.php">
                                        
                                        <!-- End .form-group  -->
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for="">New Home Category</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input type="text" name="catname" class="form-control" id="passwordfield" placeholder="New Subject" required>
                                            </div>
                                        </div> 
										
										<div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for="">Home Category Image</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input type="file" class="form-control" name="image" id="fileUpload" required>
                                            </div>
                                        </div> 
