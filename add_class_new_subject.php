            ...
            <div class="main-content">
                ...
                <div class="content">
                    <div id="checkAll-active" class="row gallery sortable-layout">
                        ...
                        <!-- col-lg-12   end here -->
                        <form  class="form-horizontal group-border stripped" method="post" action="add_update_class_subject.php" enctype="multipart/form-data" onsubmit="return validation()">
                                <div class="form-group">
							  ...
							  <div class="form-group">
                                    <label class="col-lg-12 control-label" for="">Class Name</label>
                                    <div class="col-lg-12">
									<input type="hidden" name="class_id"  value=<?php echo $class_id;?>>
                                        <input type="text" class="form-control" id="" name="class_name" value=<?php echo $class_name;?>>
                                    </div>
                                </div>
                                <!-- End .form-group  -->
											...
											for($i =1 ; $i<=20 ;$i++) { 	
												...
												?>
												  <tr>
													...
													<td><input type="file" class="form-control" name="image[]" id="fileUpload_<?php echo $i;?>"></td>
