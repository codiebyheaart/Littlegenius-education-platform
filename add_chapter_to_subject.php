        ...
        <header class="top-bar">
            <nav class="navbar navbar-default">
                <ul class="nav navbar-nav">
                    ...
                    <li class="page-title">
                        <h2>Add Chapter's in subjects</h2>
                    </li>
                </ul>
            ...
            <div class="main-content">
                ...
                <div class="content">
                    <div id="checkAll-active" class="row gallery sortable-layout">
                        ...
                        <!-- col-lg-12   end here -->
                        <form  class="form-horizontal group-border stripped" method="post" action="add_submit_chapter.php" enctype="multipart/form-data" onsubmit="return validation()">
                                <div class="form-group">
										  <div class="col-lg-15 col-md-9">
                                            
											<td><input style="color:red;" type="submit" name="Submit" value="Submit" ></td>
											</div>
                                        </div>  
							  ...
							  <div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <select  name="subject_id" class="fancy-select form-control fancified" id="subjects">
								...
								<table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="per20">Chapter Name</th>
										...
										<?php 
											...
											for($i =1 ; $i<=50 ;$i++) { 	
												...
												?>
												  <tr>
													<td><?php echo $i;?></td>
													<td><input type="text" id="subject_<?php echo $i;?>" class="form-control" name="subject[]" placeholder="Chapter name"></td>
