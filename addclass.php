                ...
                <div class="content">
                    <div id="checkAll-active" class="row gallery sortable-layout">
                                ...
                                <div class="page-header-controls">
                                    <div class="btn-group mr15" role="group">
                                        <div class="checkbox-custom mt0">
											...
											<input type="text">
											<a href="#" class="btn btn-danger btn-sm"><i class="fa fa-trash-o mr5"></i>Trash</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                              <div class="col-lg-12">
                            <!-- col-lg-12 start here -->
                            <div class="panel panel-default plain panelToggle panelClose panelRefresh">
                                <!-- Start .panel -->
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="per20">Category Name</th>
											...
											while($res = mysqli_fetch_array($result)) { 	
												...
												?>
												  <tr>
													...
													<td><?php
									echo "<a href=\"edit_cat_sub_class.php?id=$res[classid]\">Edit</a> | <a href=\"delete_class.php?id=$res[classid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";		
									?></td>                                                
												</tr>
												<?php
					...
					<h4 class="modal-title" id="exampleModalLabel">Add new</h4>
                        ...
                        <div class="modal-body" style="width: 1000px;">
                            ...
                            <form class="form-horizontal mt20 bt" role="form">
                                <div class="form-group">
                                    <label class="col-lg-12 control-label" for="">no testing</label>
                                    <div class="col-lg-12">
								...
								<table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="per30">Image Upload</th>
												 <th class="per40">Action</th>
											...
											for($i =0 ; $i<=20 ;$i++) { 	
												...
												?>
												  <tr>
													...
													<td></td>
													<td><?php
									echo "<a href=\"delete_class.php?id=$res[classid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";		
									?></td>                                                
												</tr>
												<?php
							 ...
							 <button class="btn btn-primary mdi mdi-plus" type="button" id="addRowData" onclick="test();"><i class="mdi mdi-plus-box"></i>X</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:max-content;">
      ...
      <div class="modal-body">
        <form enctype="multipart/form-data" method="post" action="add_submit_class.php">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">New Class</label>
          ...
          <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="per10">S.No</th>
                                                <th class="per20">Subject_Name</th>
                                                <th class="per30">Image_Upload</th>
												<th class="per40">Action</th>
										...
										<?php 
											...
											for($i =0 ; $i<=20 ;$i++) { 	
												...
												?>
												  <tr>
													<td><?php echo ++$sl; ?></td>
													<td><input type="text" class="form-control" name="subject_1" placeholder="" ></td>
      ...
      <div class="modal-footer">
        ...
        <button type="button"   value="Submit" id="submitBtn" name="Submit"class="btn btn-success success">Submit</button>
      </div>
	  </form>
    </div>
  </div>
...
<![endif]-->
  ...
  var modal = $(this)
  modal.find('.modal-title').text('Add class and Subjects')
...
$('#myModal').modal('handleUpdate') 
	...
	var counter = 1;
		function addRow() {
            ...
            document.getElementById('add_input_box_'+counter).innerHTML='<input type="text" class="form-control" id="subject_'+indexValue+'" name="" placeholder="">';
 ...
 //   indexValue= i++;
  ...
  
  {
	 ...
	 var node = document.getElementById("add_subject");
	var textnode = '<tr id="add_input_box_'+counter+'"> <td>1</td><td><input type="text" class="form-control" id="" name="" placeholder=""></td><td><input type="text" class="form-control" id="" name="" placeholder=""></td><td><input type="text" class="form-control" id="" name="" placeholder=""></td>'
	node.innerHTML = node.innerHTML + textnode; 
  ...
  $('#submitBtn').click(function() {
     $('#uname').text($('#Subject_Name').val());
     $('#psw').text($('#Image_Upload').val());
});

 var btn = document.getElementById('myBtn');
    btn.addEventListener('click', function() {
      document.location.href = 'add_new_class.php';
    });
