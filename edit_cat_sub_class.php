...
$result1 = mysqli_query($mysqli, "SELECT * FROM product_cat ORDER BY id DESC"); 
...
{ 	
	...
	if(empty($pcat))
	{
		echo "<font color='red'>Category field is empty.</font><br/>";		 
			...
			$result = mysqli_query($mysqli, "UPDATE  `product_cat` SET  `header`='$pcat'  WHERE `id` = $id" );
...
<?php
$id = $_GET['id'];
$result = mysqli_query($mysqli, "SELECT * FROM new_classs left JOIN class_subfolder on new_classs.classid=class_subfolder.cat_id WHERE classid=$id");
        ...
        <div class="page-container">
           ...
           <?php include('sidebar.php'); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default panelMove panelFullscreen panelToggle panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                     <form class="form-horizontal group-border stripped"  method="post" action ="update_sub_class.php">
                                          
										 <div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for="">Class Name</label>
                                             <div class="col-lg-10 col-md-9">											  
                                                  <div class="col-lg-10 col-md-9">
												  <input   type="text" name="class_name" class="form-control" value="<?php echo $cat_name;?>"  id="class_name" placeholder="Product Name">                                               
                                            </div>											
                                            </div>
                                        </div>  
										...
										<div class="form-group">
                                            <label class="col  col-md-5  control-label" style="align-content:center; color:red;" for=""><span><b>Class Subjects</b></span></label>
                                             
                                        </div> 
											<?php
										$id = $_GET['id'];
										$result = mysqli_query($mysqli, "SELECT  classid , cat_name,header ,sub ,refid , cat_id ,sub_cat_name ,sub_images FROM new_classs left JOIN class_subfolder on new_classs.classid=class_subfolder.cat_id WHERE classid=$id");
										...
										?>
                                         <div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for=""><?php echo $sub_cat_name;?></label>
                                             <div class="col-lg-10 col-md-9">											  
                                                  <div class="col-lg-10 col-md-9">
												   <input type="hidden" name="subject_id[]" value="<?php echo $refid;?>">
												  <input   type="text"  name="name[]" class="form-control" value="<?php echo $sub_cat_name;?>"  id="subject_name" placeholder="Product Name"> 
											<?php
									echo "<a href=\"delete_class_subjects.php?id=$refid\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> |<a href=\"edit_subject_chapter.php?id=$refid\">update chapters</a>";		
									?>	  
												</div>											
                                            </div>
                                        </div> 
			...
			?>
									...
									<form class="form-horizontal group-border stripped"  method="post" action ="add_class_new_subject.php">
									<input type="hidden" name="class_id" value=<?php echo $_GET['id'];?>>
									<input type="hidden" name="class_name" value=<?php echo $cat_name;?>>
									<button type="submit"  name="Submit"  class="btn btn-primary" id="myBtn">
									ADD NEW SUBJECT
								     </button>
									 </form>
                                        </div>
