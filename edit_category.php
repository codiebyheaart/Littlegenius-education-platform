...
{ 	
	...
	if(empty($pcat))
	{
		echo "<font color='red'>Category field is empty.</font><br/>";		 
			...
			$result = mysqli_query($mysqli, "UPDATE  `product_cat` SET  `cat_name`='$pcat'  WHERE `id` = $id" );
...
<?php
$id = $_GET['id'];
$result = mysqli_query($mysqli, "SELECT * FROM product_cat WHERE id=$id");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default panelMove panelFullscreen panelToggle panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                     <form class="form-horizontal group-border stripped"  method="post" action="edit_category.php">
                                          
										 <div class="form-group">
                                            <label class="col-lg-2 col-md-3  control-label" for="">New Category</label>
                                             <div class="col-lg-10 col-md-9">											  
                                                  <div class="col-lg-10 col-md-9">
												  <input   type="text" name="pcat" class="form-control" value="<?php echo $cat_name;?>"  id="passwordfield" placeholder="Product Name">                                               
                                            </div>											
                                            </div>
                                        </div>                                         
										<div class="form-group">
