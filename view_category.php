...
$result = mysqli_query($mysqli, "SELECT * FROM product_cat ORDER BY id DESC"); // using mysqli_query instead
?>
<!doctype html>
                    ...
                    <div id="checkAll-active" class="row gallery sortable-layout">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="page-header gallery-category-name">
                                <h5>All Main Subject</h5>
                                <div class="page-header-controls">
                                    <div class="btn-group mr15" role="group">
                                        <div class="checkbox-custom mt0">
                                            
                                            <label for="masterCheckbox">Edit Any Subject Name</label>
											<input type="text">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default plain panelToggle panelClose panelRefresh">
                                ...
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title">All Subject</h4>
                                </div>
											...
											while($res = mysqli_fetch_array($result)) { 	
												...
												?>
												  <tr>
													...
													<td><?php
									echo "<a href=\"edit_category.php?id=$res[id]\">Edit</a> | <a href=\"delete_category.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";		
									?></td>                                                
												</tr>
												<?php
