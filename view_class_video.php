...
$result = mysqli_query($mysqli, "SELECT * FROM header_subjects ORDER BY id DESC"); // using mysqli_query instead
?>
<!doctype html>
							...
							while($res = mysqli_fetch_array($result)) { 		
								...
								<div class="panel panel-default">
								   <div class="panel-body">
									...
									<?php
									echo "<a href=\"update_class_video.php?id=$res[id]\">Edit</a> | <a href=\"delete_product.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";		
									?>
		...
		if(str == "")
			...
			var post_id = 'id='+ str;
				$.ajax
								({
					type: "POST",
                    url: "delete_all_class_product.php",
                    data: post_id,
                    cache: false,
